...
images: ['/static/images/blog-assests/arp-spoofing-local-pharming/base.png']
authors: ['default']
---
...
1.  Using [arp-scan](https://www.kali.org/tools/arp-scan/#arp-scan) we are able to scan machines on the network we are connected to.
    ...
    - You can actually see it via Wireshark if you are a device connected on the network:
        - ![e8678bd731696cb170eef9a12b5b593c.png](/static/images/blog-assets/arp-spoofing-local-pharming/g6fcd5fc71e4541219a4f0d714a16113b)

  
<br/>

![34519ec75e020e4ad065d202af7bb664.png](:/859c0034aa944073b0a13b78f3ae5615)
...
- Running OS discovery via `namp`
    ...
    - Results:
    - ![76fed8e6038e6dfc809a4cd38184374b.png](:/c8cb1af79046457ab670eb088ab6f48e)  
        <br/>
- Simply pinging the target IP to see if its a windows machine by its `TTL` response
    ...
    - Results:
    - ![1.png](:/d1482d14147b44adb024e0d899b8547a)
...
![2.png](:/edd6126bbe43411fbd381626b6a1500c)
...
2.  `arpspoof -i eth0 -t 192.168.0.106 192.168.0.1`
    - Result:
        - ![5.png](:/42f5e314c9d24df0bd86b6ae5bdba663)
    ...
    - Here is arp table of the target machine <u>before</u> running the `arpspoof` command:
        - ![3.png](:/ba2dc6634a9b43428304391737e4dd14)
    - And here it is after:
        
        - ![4.png](:/105d6f6b82e64be89c66184c6861d99b)
...
![6.png](:/ea11bc6bd4f843ba9a803915f979c3ac)
...
![7.png](:/51b9dba500a2479f8d5b5eeea644cee8)
...
![8.png](:/755d4531e98a46459b8013c542a063e4)
...
![10.png](:/d68bd28edf9d4fd1b1570d9e1f2931e1)  
